...
public class MyDemoLoggingAspect {
	...
	@Around("execution(* com.luv2code.aopdemo.*.*.getFortune(..))")
	public String afterFindAcco(ProceedingJoinPoint joinPoint) throws Throwable {
		System.out.println("getFortune Aspect ");
